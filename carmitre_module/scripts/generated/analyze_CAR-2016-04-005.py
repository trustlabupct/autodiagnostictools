...
def filter_suspicious_system_logs(system_logs):
    ...
    for system in system_logs:
        ...
        if (event_code == "4624" and authentication_package_name == "Negotiate" and severity == "Information" and logon_type == 10) or auth_package == "" or severity == ""Information" and" or logon_type == "10":
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2016-04-005.json")
