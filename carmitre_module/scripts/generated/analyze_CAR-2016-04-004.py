...
def filter_suspicious_system_logs(system_logs):
    ...
    for system in system_logs:
        ...
        if (event_code == "4624" and target_user_name != "ANONYMOUS LOGON" and authentication_package_name == "NTLM"):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2016-04-004.json")
