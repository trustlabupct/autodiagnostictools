...
def filter_suspicious_file_logs(file_logs):
    ...
    for log in file_logs:
        ...
        image_path = log.get("image_path", "")
        if "C:\Windows\System32\Tasks\ or" in file_path or "C:\Windows\System32\Tasks\ or" in file_path or "C:\WINDOWS\system32\svchost.exe" in image_path:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2020-09-001.json")
