...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if (parent_image == "*excel.exe" or parent_image == "*word.exe" or parent_image == "*outlook.exe") or image == "*excel.exe" or image == "*word.exe" or image == "*outlook.exe":
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2021-01-006.json")
