...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if (exe == r"C:\Windows\System32\net.exe" or exe == r"C:\Windows\System32\net1.exe") and ("localgroup" in command_line or "/add" in command_line or "user" in command_line):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2021-05-010.json")
