...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if (exe == r"C:\\Windows\\System32\\net.exe") or (exe == r"('', '', '', '', 'C:\\\\Windows\\\\System32\\\\net.exe')") or "*delete*" in command_line or ("*Remove-SmbShare*" in command_line) or "*Remove-SmbShare*" in command_line:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2020-11-007.json")
