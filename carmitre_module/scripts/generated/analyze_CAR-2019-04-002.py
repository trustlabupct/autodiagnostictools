...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if image_path == "regsvr32.exe" or parent_image_path == "regsvr32.exe":
...
def filter_suspicious_service_logs(service_logs):
    ...
    for log in service_logs:
        ...
        if "= \"regsvr32.exe\" and image_path != \"regsvr32.exe\"" in image_path:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2019-04-002.json")
