...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if image_path == "C:WindowsSystem32services.exe" or parent_image_path == "C:\Windows\System32\services.exe" or image_path == "C:WindowsSystem32cmd.exe" or cmd == "echo" or cmd == "pipe" or image_path == "C:WindowsSystem32rundll32.exe" or cmd == ",a":
...
def filter_suspicious_service_logs(service_logs):
    ...
    for log in service_logs:
        ...
        if "= C:\Windows\System32\services.exe\" AND" in image_path or "= \"C:\Windows\System32\cmd.exe\" AND" in image_path or "= \"C:\Windows\System32\rundll32.exe\" AND" in image_path:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2021-02-002.json")
