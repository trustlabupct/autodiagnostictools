...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if cmd == "scrobj.dll" or image_path == "regsvr32.exe":
...
def filter_suspicious_service_logs(service_logs):
    ...
    for log in service_logs:
        ...
        if "= \"regsvr32.exe\" and command_line == \"scrobj.dll\"" in image_path:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2019-04-003.json")
