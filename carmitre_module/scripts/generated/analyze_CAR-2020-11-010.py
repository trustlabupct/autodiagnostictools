...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if (exe == r"C:\Windows\System32\CMSTP.exe") or (exe == r"('', '', '', '', 'C:\\Windows\\System32\\CMSTP.exe')"):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2020-11-010.json")
