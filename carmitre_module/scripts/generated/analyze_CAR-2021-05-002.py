...
def filter_suspicious_file_logs(file_logs):
    ...
    for log in file_logs:
        ...
        image_path = log.get("image_path", "")
        if (
            "C:\Windows\system32 " in file_path
            or ".bat AND file_path = C:\Windows\system32 " in extension
            or ".bat AND file_path = C:\Windows\system32 " in extension
            and "C:\Windows\system32 " in file_path
        ):
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(
        base_dir, "..", "..", "output", "suspicious_results_CAR-2021-05-002.json"
    )
