...
def filter_suspicious_network_logs(network_logs):
    ...
    for log in network_logs:
        ...
        port = log.get("port", "")
        data = log.get("data", "")
        if "445" in port or "445" in dest_port or ".pipe == \"ATSVC\"" in proto_info or ".function == \"JobAdd\"" in proto_info:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2015-04-001.json")
