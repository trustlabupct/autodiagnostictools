...
def filter_suspicious_network_logs(network_logs):
    ...
    for log in network_logs:
        ...
        port = log.get("port", "")
        data = log.get("data", "")
        if "135" in port or "135" in dest_port or ".rpc_interface == \"IRemUnknown2\"" in proto_info:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2014-11-007.json")
