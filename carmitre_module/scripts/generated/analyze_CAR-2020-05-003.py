...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if (
            (exe == r"At.exe" or exe == r"Atbroker.exe")
            or (exe == r"Bash.exe" or exe == r"Bitsadmin.exe")
            or (exe == r"Certutil.exe" or exe == r"Cmd.exe")
            or (exe == r"Cmdkey.exe" or exe == r"Cmstp.exe")
            or (exe == r"Control.exe" or exe == r"Csc.exe")
            or (exe == r"Cscript.exe" or exe == r"Dfsvc.exe")
            or (exe == r"Diskshadow.exe" or exe == r"Dnscmd.exe")
            or (exe == r"Esentutl.exe" or exe == r"Eventvwr.exe")
            or (exe == r"Expand.exe" or exe == r"Extexport.exe")
            or (exe == r"Extrac32.exe" or exe == r"Findstr.exe")
            or (exe == r"Forfiles.exe" or exe == r"Ftp.exe")
            or (exe == r"Gpscript.exe" or exe == r"Hh.exe")
            or (exe == r"Ie4uinit.exe" or exe == r"Ieexec.exe")
            or (exe == r"Infdefaultinstall.exe" or exe == r"Installutil.exe")
            or (exe == r"Jsc.exe" or exe == r"Makecab.exe")
            or (exe == r"Mavinject.exe" or exe == r"Microsoft.Workflow.r.exe")
            or (exe == r"Mmc.exe" or exe == r"Msbuild.exe")
            or (exe == r"Msconfig.exe" or exe == r"Msdt.exe")
            or (exe == r"Mshta.exe" or exe == r"Msiexec.exe")
            or (exe == r"Odbcconf.exe" or exe == r"Pcalua.exe")
            or (exe == r"Pcwrun.exe" or exe == r"Presentationhost.exe")
            or (exe == r"Print.exe" or exe == r"Reg.exe")
            or (exe == r"Regasm.exe" or exe == r"Regedit.exe")
            or (exe == r"Register-cimprovider.exe" or exe == r"Regsvcs.exe")
            or (exe == r"Regsvr32.exe" or exe == r"Replace.exe")
            or (exe == r"Rpcping.exe" or exe == r"Rundll32.exe")
            or (exe == r"Runonce.exe" or exe == r"Runscripthelper.exe")
            or (exe == r"Sc.exe" or exe == r"Schtasks.exe")
            or (exe == r"Scriptrunner.exe" or exe == r"SyncAppvPublishingServer.exe")
            or (exe == r"Tttracer.exe" or exe == r"Verclsid.exe")
            or (exe == r"Wab.exe" or exe == r"Wmic.exe")
            or (exe == r"Wscript.exe" or exe == r"Wsreset.exe")
            or (exe == r"Xwizard.exe" or exe == r"Advpack.dll OR exe = ")
            or (exe == r"Appvlp.exe" or exe == r"Bginfo.exe")
            or (exe == r"Cdb.exe" or exe == r"csi.exe")
            or (exe == r"Devtoolslauncher.exe" or exe == r"dnx.exe")
            or (exe == r"Dxcap.exe" or exe == r"Excel.exe")
            or (exe == r"Mftrace.exe" or exe == r"Msdeploy.exe")
            or (exe == r"msxsl.exe" or exe == r"Powerpnt.exe")
            or (exe == r"rcsi.exe" or exe == r"Sqler.exe")
            or (exe == r"Sqlps.exe" or exe == r"SQLToolsPS.exe")
            or (exe == r"Squirrel.exe" or exe == r"te.exe")
            or (exe == r"Tracker.exe" or exe == r"Update.exe")
            or (exe == r"vsjitdebugger.exe" or exe == r"Winword.exe")
            or (exe == r"Wsl.exe" or exe == r"CL_Mutexverifiers.ps1 OR exe = ")
            or (exe == r"('At.exe', '', '', '', '')")
            or (exe == r"('Atbroker.exe', '', '', '', '')")
            or (exe == r"('Bash.exe', '', '', '', '')")
            or (exe == r"('Bitsadmin.exe', '', '', '', '')")
            or (exe == r"('Certutil.exe', '', '', '', '')")
            or (exe == r"('Cmd.exe', '', '', '', '')")
            or (exe == r"('Cmdkey.exe', '', '', '', '')")
            or (exe == r"('Cmstp.exe', '', '', '', '')")
            or (exe == r"('Control.exe', '', '', '', '')")
            or (exe == r"('Csc.exe', '', '', '', '')")
            or (exe == r"('Cscript.exe', '', '', '', '')")
            or (exe == r"('Dfsvc.exe', '', '', '', '')")
            or (exe == r"('Diskshadow.exe', '', '', '', '')")
            or (exe == r"('Dnscmd.exe', '', '', '', '')")
            or (exe == r"('Esentutl.exe', '', '', '', '')")
            or (exe == r"('Eventvwr.exe', '', '', '', '')")
            or (exe == r"('Expand.exe', '', '', '', '')")
            or (exe == r"('Extexport.exe', '', '', '', '')")
            or (exe == r"('Extrac32.exe', '', '', '', '')")
            or (exe == r"('Findstr.exe', '', '', '', '')")
            or (exe == r"('Forfiles.exe', '', '', '', '')")
            or (exe == r"('Ftp.exe', '', '', '', '')")
            or (exe == r"('Gpscript.exe', '', '', '', '')")
            or (exe == r"('Hh.exe', '', '', '', '')")
            or (exe == r"('Ie4uinit.exe', '', '', '', '')")
            or (exe == r"('Ieexec.exe', '', '', '', '')")
            or (exe == r"('Infdefaultinstall.exe', '', '', '', '')")
            or (exe == r"('Installutil.exe', '', '', '', '')")
            or (exe == r"('Jsc.exe', '', '', '', '')")
            or (exe == r"('Makecab.exe', '', '', '', '')")
            or (exe == r"('Mavinject.exe', '', '', '', '')")
            or (exe == r"('Microsoft.Workflow.r.exe', '', '', '', '')")
            or (exe == r"('Mmc.exe', '', '', '', '')")
            or (exe == r"('Msbuild.exe', '', '', '', '')")
            or (exe == r"('Msconfig.exe', '', '', '', '')")
            or (exe == r"('Msdt.exe', '', '', '', '')")
            or (exe == r"('Mshta.exe', '', '', '', '')")
            or (exe == r"('Msiexec.exe', '', '', '', '')")
            or (exe == r"('Odbcconf.exe', '', '', '', '')")
            or (exe == r"('Pcalua.exe', '', '', '', '')")
            or (exe == r"('Pcwrun.exe', '', '', '', '')")
            or (exe == r"('Presentationhost.exe', '', '', '', '')")
            or (exe == r"('Print.exe', '', '', '', '')")
            or (exe == r"('Reg.exe', '', '', '', '')")
            or (exe == r"('Regasm.exe', '', '', '', '')")
            or (exe == r"('Regedit.exe', '', '', '', '')")
            or (exe == r"('Register-cimprovider.exe', '', '', '', '')")
            or (exe == r"('Regsvcs.exe', '', '', '', '')")
            or (exe == r"('Regsvr32.exe', '', '', '', '')")
            or (exe == r"('Replace.exe', '', '', '', '')")
            or (exe == r"('Rpcping.exe', '', '', '', '')")
            or (exe == r"('Rundll32.exe', '', '', '', '')")
            or (exe == r"('Runonce.exe', '', '', '', '')")
            or (exe == r"('Runscripthelper.exe', '', '', '', '')")
            or (exe == r"('Sc.exe', '', '', '', '')")
            or (exe == r"('Schtasks.exe', '', '', '', '')")
            or (exe == r"('Scriptrunner.exe', '', '', '', '')")
            or (exe == r"('SyncAppvPublishingServer.exe', '', '', '', '')")
            or (exe == r"('Tttracer.exe', '', '', '', '')")
            or (exe == r"('Verclsid.exe', '', '', '', '')")
            or (exe == r"('Wab.exe', '', '', '', '')")
            or (exe == r"('Wmic.exe', '', '', '', '')")
            or (exe == r"('Wscript.exe', '', '', '', '')")
            or (exe == r"('Wsreset.exe', '', '', '', '')")
            or (exe == r"('Xwizard.exe', '', '', '', '')")
            or (exe == r"('', '', '', '', 'Advpack.dll OR exe = ')")
            or (exe == r"('', '', '', '', 'Ieadvpack.dll OR exe = ')")
            or (exe == r"('', '', '', '', 'Mshtml.dll OR exe = ')")
            or (exe == r"('', '', '', '', 'Setupapi.dll OR exe = ')")
            or (exe == r"('', '', '', '', 'Shell32.dll OR exe = ')")
            or (exe == r"('', '', '', '', 'Url.dll OR exe = ')")
            or (exe == r"('Appvlp.exe', '', '', '', '')")
            or (exe == r"('Bginfo.exe', '', '', '', '')")
            or (exe == r"('Cdb.exe', '', '', '', '')")
            or (exe == r"('csi.exe', '', '', '', '')")
            or (exe == r"('Devtoolslauncher.exe', '', '', '', '')")
            or (exe == r"('dnx.exe', '', '', '', '')")
            or (exe == r"('Dxcap.exe', '', '', '', '')")
            or (exe == r"('Excel.exe', '', '', '', '')")
            or (exe == r"('Mftrace.exe', '', '', '', '')")
            or (exe == r"('Msdeploy.exe', '', '', '', '')")
            or (exe == r"('msxsl.exe', '', '', '', '')")
            or (exe == r"('Powerpnt.exe', '', '', '', '')")
            or (exe == r"('rcsi.exe', '', '', '', '')")
            or (exe == r"('Sqler.exe', '', '', '', '')")
            or (exe == r"('Sqlps.exe', '', '', '', '')")
            or (exe == r"('SQLToolsPS.exe', '', '', '', '')")
            or (exe == r"('Squirrel.exe', '', '', '', '')")
            or (exe == r"('te.exe', '', '', '', '')")
            or (exe == r"('Tracker.exe', '', '', '', '')")
            or (exe == r"('Update.exe', '', '', '', '')")
            or (exe == r"('vsjitdebugger.exe', '', '', '', '')")
            or (exe == r"('Winword.exe', '', '', '', '')")
            or (exe == r"('Wsl.exe', '', '', '', '')")
            or (exe == r"('', '', '', '', 'CL_Mutexverifiers.ps1 OR exe = ')")
            or (exe == r"('', '', '', '', 'Manage-bde.wsf OR exe = ')")
            or (exe == r"('', '', '', '', 'Slmgr.vbs OR exe = ')")
            or (exe == r"('', '', '', '', 'winrm.vbs OR exe = ')")
        ):
...
def main():
    ...
    output_file = os.path.join(
        base_dir, "..", "..", "output", "suspicious_results_CAR-2020-05-003.json"
    )
