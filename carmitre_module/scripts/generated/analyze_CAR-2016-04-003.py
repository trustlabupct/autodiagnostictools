...
def filter_suspicious_system_logs(system_logs):
    ...
    for log in system_logs:
        ...
        if "System" in log_name or "7036" in event_code or "['Windows Defender', ' Windows Firewall] AND']" in param1 or "stopped" in param2:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2016-04-003.json")
