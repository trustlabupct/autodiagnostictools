...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if (exe == "arp.exe" or exe == "at.exe" or exe == "attrib.exe") or exe == "arp.exe" or (exe == "cscript.exe" or exe == "dsquery.exe" or exe == "hostname.exe") or exe == "cscript.exe" or (exe == "ipconfig.exe" or exe == "mimikatz.exe" or exe == "nbstat.exe") or exe == "ipconfig.exe" or (exe == "net.exe" or exe == "netsh.exe" or exe == "nslookup.exe") or exe == "net.exe" or (exe == "ping.exe" or exe == "quser.exe" or exe == "qwinsta.exe") or exe == "ping.exe" or (exe == "reg.exe" or exe == "runas.exe" or exe == "sc.exe") or exe == "reg.exe" or (exe == "schtasks.exe" or exe == "ssh.exe" or exe == "systeminfo.exe") or exe == "schtasks.exe" or (exe == "taskkill.exe" or exe == "telnet.exe" or exe == "tracert.exe") or exe == "taskkill.exe" or (exe == "wscript.exe" or exe == "xcopy.exe") or exe == "wscript.exe":
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2013-04-002.json")
