...
def filter_suspicious_system_logs(system_logs):
    ...
    for system in system_logs:
        ...
        if ((log_name == "Security" and event_code in [1100, 1102, 1104]) or (log_name == "System" and event_code == 104)):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2016-04-002.json")
