...
def filter_suspicious_system_logs(system_logs):
    ...
    for system in system_logs:
        ...
        if (log_name == "Security" and event_code == "4670" and object_type == "File" and subject_security_id != "NT AUTHORITY\SYSTEM"):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2019-07-001.json")
