...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if "*reg*" in command_line or "*add*" in command_line or "*Common Startup*" in command_line or ("*reg*" in command_line and "*add*" in command_line):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2021-12-002.json")
