...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if image_path == "C:WindowsSystem32services.exe" or parent_image_path == "C:\Windows\System32\services.exe":
...
def filter_suspicious_service_logs(service_logs):
    ...
    for log in service_logs:
        ...
        if "= \"C:\Windows\System32\services.exe\"" in image_path:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2013-09-005.json")
