...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if image_path == ":RECYCLER" or image_path == ":SystemVolumeInformation" or image_path == "%windir%Tasks" or image_path == "%systemroot%debug":
...
def filter_suspicious_service_logs(service_logs):
    ...
    for log in service_logs:
        ...
        if "= \":\RECYCLER\\" or" in image_path or "= \":\SystemVolumeInformation\\" or" in image_path or "= \"%windir%\Tasks\\" or" in image_path or "= \"%systemroot%\debug\\"" in image_path:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2013-05-002.json")
