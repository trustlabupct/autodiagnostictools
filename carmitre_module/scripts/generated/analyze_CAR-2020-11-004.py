...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if exe == "smss.exe" or exe == "csrss.exe" or exe == "wininit.exe" or exe == "winlogon.exe" or exe == "lsass.exe" or exe == "LogonUI.exe" or exe == "services.exe" or exe == "spoolsv.exe" or exe == "taskhost.exe" or exe == "taskhostw.exe" or exe == "userinit.exe":
