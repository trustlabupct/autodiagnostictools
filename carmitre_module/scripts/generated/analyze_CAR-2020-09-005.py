...
def filter_suspicious_registry_keys(registry_logs):
    ...
    for reg in registry_logs:
        ...
        key = reg.get("key", "")
        if (
            "SOFTWAREMicrosoftWindows" in key
            or "SOFTWAREWow6432NodeMicrosoftWindows" in key
        ):
...
def main():
    ...
    output_file = os.path.join(
        base_dir, "..", "..", "output", "suspicious_results_CAR-2020-09-005.json"
    )
