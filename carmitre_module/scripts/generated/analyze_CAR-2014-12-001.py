...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if (exe == "wmiprvse.exe") or exe == "wmiprvse.exe":
...
def filter_suspicious_network_logs(network_logs):
    ...
    for log in network_logs:
        ...
        if (src_port >= 49152 and dest_port >= 49152 and proto_info.rpc_interface == "IRemUnknown2"):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2014-12-001.json")
