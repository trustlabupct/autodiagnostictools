...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if (smb_write.hostname == process.hostname and smb_write.file_path == process.image_path and smb_write.time < process.time):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2013-05-005.json")
