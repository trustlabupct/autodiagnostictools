...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if "*SCHTASKS*" in command_line or "*javascript*" in command_line or "*powershell*" in command_line or "*wmic*" in command_line or "*rundll32*" in command_line or "*cmd*" in command_line or "*cscript*" in command_line or "*wscript*" in command_line or "*regsvr32*" in command_line or "*mshta*" in command_line or "*bitsadmin*" in command_line or "*certutil*" in command_line or "*msiexec*" in command_line or "*javaw*" in command_line or ("*javascript*" in command_line or "*powershell*" in command_line) or ("*wmic*" in command_line or "*rundll32*" in command_line) or ("*cmd*" in command_line or "*cscript*" in command_line) or ("*wscript*" in command_line or "*regsvr32*" in command_line) or ("*mshta*" in command_line or "*bitsadmin*" in command_line) or ("*certutil*" in command_line or "*msiexec*" in command_line):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2021-12-001.json")
