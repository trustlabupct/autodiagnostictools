...
def filter_suspicious_network_logs(network_logs):
    ...
    for log in network_logs:
        ...
        if (dest_port == 445 and proto_info.pipe == "WINREG") or (proto_info.function == "Create*" or proto_info.function == "SetValue*"):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2014-11-005.json")
