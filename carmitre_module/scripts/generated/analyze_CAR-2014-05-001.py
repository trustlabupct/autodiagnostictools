...
def filter_suspicious_network_logs(network_logs):
    ...
    for log in network_logs:
        ...
        port = log.get("port", "")
        data = log.get("data", "")
        if "135" in port or "135)" in dest_port or "49152)" in src_port or "49152" in dest_port:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2014-05-001.json")
