...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if (exe == "winlogon.exe" or exe == "cmd.exe") or (parent_exe == "winlogon.exe" and exe == "cmd.exe"):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2014-11-008.json")
