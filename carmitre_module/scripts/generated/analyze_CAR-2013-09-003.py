...
def filter_suspicious_network_logs(network_logs):
    ...
    for log in network_logs:
        ...
        port = log.get("port", "")
        data = log.get("data", "")
        if "445" in port or "445" in dest_port or "smb.setup" in protocol or ".user_name" in proto_info or ".hostname" in proto_info:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2013-09-003.json")
