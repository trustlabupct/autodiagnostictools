...
def filter_suspicious_file_logs(file_logs):
    ...
    for log in file_logs:
        ...
        image_path = log.get("image_path", "")
        if "= service_process.image_path" in file_path or "= service_process.image_path" in file_path:
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2014-02-001.json")
