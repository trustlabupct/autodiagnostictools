...
def filter_suspicious_processes(process_logs):
    ...
    for process in process_logs:
        ...
        if (exe == r"C:\Windows\System32\certutil.exe") and ("urlcache" in command_line) or (exe == r"('', '', '', '', 'C:\\Windows\\System32\\certutil.exe')"):
...
def main():
    ...
    output_file = os.path.join(base_dir, "..", "..", "output", "suspicious_results_CAR-2021-05-006.json")
